...
import com.shahidul.flickr.wallpaper.activity.PagerActivity;
...
public void onSaveInstanceState(Bundle outState) {
	...
	private class ImageGridViewAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			imageLoader.displayImage(mPhotos.get(position).getThumbnailImageUrl(), holder.imageView, options, new SimpleImageLoadingListener() {
										 @Override

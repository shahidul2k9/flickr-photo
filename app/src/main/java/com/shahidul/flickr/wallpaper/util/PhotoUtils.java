package com.shahidul.flickr.wallpaper.util;
...
public class PhotoUtils {
	...
	private static final String API_KEY_VALUE = "54bd92255566409d71b06aadfae615f1";
...
public static String getGroupUrl(String group){
	...
	public static String createURL(String type, Photo p) {
		return String.format("http://farm%s.staticflickr.com/%s/%s_%s_%s.jpg", p.getFarId(), p.getServerId(), p.getPhotoId(), p.getSecret(), type.substring(type.length()-1));
	}
}
